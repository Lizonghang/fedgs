...
def compare_sgdd_with_different_init_points():
    """Compare the optimization curves of SGDD with different
    initialization points."""
    init_strategy = ["Zero Init", "Rand Init", "MPInv Init"]
    dist_info = {
        "Zero Init": [0.123, 0.105, 0.075, 0.060, 0.047,
                      0.042, 0.036, 0.033, 0.030],
        "Rand Init": [0.055, 0.046, 0.044],
        "MPInv Init": [0.037, 0.035, 0.031, 0.029]
    }
    visualization_utils.compare_sgdd_with_different_init_points(
